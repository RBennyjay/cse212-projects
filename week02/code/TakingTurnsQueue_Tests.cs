...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The logic in GetNextPerson() was flawed. It failed to re-enqueue a person who had exactly one turn remaining, causing the queue to empty prematurely and the final sequence to be incorrect. 
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The logic in GetNextPerson() was flawed. It failed to re-enqueue a person who had exactly one turn remaining, causing the sequence to be incorrect.
